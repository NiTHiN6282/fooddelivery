                          ...
                          itemBuilder: (context,index){
                            ...
                            if(cartList.isEmpty){
                              ...
                              decoration: BoxDecoration(
                                  color: Colors.white,
                                  borderRadius: BorderRadius.circular(h*0.0293)
                              ),
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              GestureDetector(
                                                    ...
                                                    if(cartList[index]['quantity']==1){
                                                      ...
                                                      showDialog<String>(
                                                        ...
                                                        builder: (BuildContext context) => AlertDialog(
                                                          ...
                                                          content: Text('Do you want to remove ${cartList[index]['name']} from cart?'),
                                                          actions: <Widget>[
                                                            TextButton(
                                                ...
                                                child: Container(
                                                  color:cartList[index]['quantity']==1?Colors.white:Color(0xffbe7f4d),
                                                  child: cartList[index]['quantity']==1?Icon(Icons.delete_forever,
                                              ...
                                              Container(
                                                  width: h*0.036,
                                                  child: Center(child: Text(cartList[index]['quantity'].toString(),
                                                    style: TextStyle(
                                                        fontSize: h*0.0185
                                                    ),)
                                                  )
                      ...
                      Container(
                          ...
                          child:Row(
                            ...
                            children: [
                              ...
                              Text('Do you have an discount code?',
                              style: TextStyle(
                                fontSize: h*0.0205
                              ),)
                            ],
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text('\$${subTotal-discount+delivery}',
                                  style: TextStyle(
                                      fontSize: h*0.0205
                                  ),),
                              ],
